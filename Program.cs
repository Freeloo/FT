...
namespace FT
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                if (powershellMode)
                {
                    ...
                    Console.ForegroundColor = ConsoleColor.White;
                    cmd.StartInfo.Arguments = Console.ReadLine();
                    ...
                    Console.ForegroundColor = ConsoleColor.White;
                    if (cmd.StartInfo.Arguments == "off")
                    {
                ...
                if (CmdPmode)
                {
                    ...
                    Process cmd = new Process();
                    cmd.StartInfo.FileName = "debian.exe";
                    Console.ForegroundColor = ConsoleColor.Yellow;
                ...
                else
                {
                    ...
                    result = request(action, ref CmdPmode, ref powershellMode);
                    Console.ForegroundColor = ConsoleColor.Green;
        ...
        static string request(string request, ref bool cmdPMode, ref bool powershellMode)
        {
            string arg1 = null;
            string result = null;
            switch (request)
                ...
                case "help":
                    {
                        ...
                        switch (arg1)
                        {
                            ...
                            case "powershell":
                                {
                                    result = " Command : cmdPrompt \ndescrition : enable the powershell mode mode \nArguments : 0";
                                    break;
                                }
                            case "start":
                                {
                ...
                case "out":
                    {
                        ...
                        stop.StartInfo.Arguments = ("/C taskkill /im ft.exe");
