...
namespace FT
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.Clear();
            Console.Write("Ft version 0.1 \\ 15 may 2020 \n ");
        ...
        { 
            ...
            switch (request)
            {
                case "help":
                    {
                        Console.ForegroundColor = ConsoleColor.Green;
                        Console.WriteLine("Command name (? for know all the possible command) : ");
                        Console.ForegroundColor = ConsoleColor.White;
                ...
                case "createF":
                    {
                        Console.ForegroundColor = ConsoleColor.Green;
                        Console.WriteLine("Dir tou create a folder, file tou create a file. ");
                        arg1=Console.ReadLine();
                        switch (arg1)
                        {
                            case "dir":
                                {
                                    Console.ForegroundColor = ConsoleColor.Green;
                                    Console.WriteLine("Path, include the folder that you create :");
                            ...
                            case "file":
                                {
                                    Console.ForegroundColor = ConsoleColor.Green;
                                    Console.WriteLine("Path, include the file that you create :");
                ...
                case "delF":
                    {
                        Console.ForegroundColor = ConsoleColor.Green;
                        Console.WriteLine("dir to delete a folder, file tou deletee a file. ");
                        arg1 = Console.ReadLine();
                        switch (arg1)
                        {
                            case "dir":
                        ...
                        Console.ForegroundColor = ConsoleColor.White;
                        File.Delete("C:\\users\\x230\\desktop\\test.txt");
                ...
                case "start":
                    {
                        Console.ForegroundColor = ConsoleColor.Green;
                        Console.WriteLine("Name of programm : ");
                        Console.ForegroundColor = ConsoleColor.White;
                ...
                default:
                    {
                        Console.ForegroundColor = ConsoleColor.Red;
                        result = " Command not found, enter help for more information";
                        Console.ForegroundColor = ConsoleColor.White;
                        break;
                    }
